...
-- --------------------------------------------------
-- Date Created: 09/12/2018 11:10:39
...
GO
IF OBJECT_ID(N'[dbo].[FK_Stock_Order_Line_Stock_Item1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Stock_Order_Line] DROP CONSTRAINT [FK_Stock_Order_Line_Stock_Item1];
GO
...
CREATE TABLE [dbo].[Employee_Shifts] (
    ...
    [Employee_Shift_Date] datetime  NOT NULL,
    [Employee_Shift_Time_Slot] varchar(50)  NOT NULL
);
GO
...
-- Creating foreign key on [Stock_ID] in table 'Stock_Order_Line'
ALTER TABLE [dbo].[Stock_Order_Line]
ADD CONSTRAINT [FK_Stock_Order_Line_Stock_Item1]
    FOREIGN KEY ([Stock_ID])
    REFERENCES [dbo].[Stock_Item]
        ([Stock_ID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Stock_Order_Line_Stock_Item1'
CREATE INDEX [IX_FK_Stock_Order_Line_Stock_Item1]
ON [dbo].[Stock_Order_Line]
    ([Stock_ID]);
GO
